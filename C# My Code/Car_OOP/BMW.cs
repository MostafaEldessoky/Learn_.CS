...
namespace Car_OOP
{
    internal class BMW : Car, IFuel
    {
        ...
        public BMW(int hp = 0, string color = "", string name = "", int km = 0, string bill = "",Boolean fuel = true, int amount = 0, int currentfuel = 10) : base(hp, color, name, km, bill)
        {
            _amount = amount;
